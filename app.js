...
passport.use(new GoogleStrategy({
        ...
        callbackURL: "https://peaceful-caverns-23939.herokuapp.com/auth/google/secrets"
    },
...
passport.use(new FacebookStrategy({
        ...
        callbackURL: "https://peaceful-caverns-23939.herokuapp.com/auth/facebook/secrets"
    },
    function (accessToken, refreshToken, profile, cb) {
        User.findOrCreate({
